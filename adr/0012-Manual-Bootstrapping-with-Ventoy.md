...
* **Manual Error Risk:** Typo risk during manual console command execution.
  * *Mitigation:* The manual commands are intentionally limited to 3 distinct lines (`systemctl` and `ufw` setup), which are documented directly in the primary `README.md`.
